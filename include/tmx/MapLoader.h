...
namespace tmx {
    ...
    public:
        ...
        void DrawLayer(sf::RenderWindow& rt, MapLayer& layer, bool debug) {
            rt.draw(layer);
        ...
        void Draw(sf::RenderWindow& rw, MapLayer ml, bool debug = false) {
            SetDrawingBounds(rw.getView());
            DrawLayer(rw,ml,false);
        }
